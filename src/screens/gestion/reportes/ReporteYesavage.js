...
export const ReporteYesavage = (vals) => {
    ...
    const llamarDatos = async () => {
        ...
        console.log(dinamicValue + "id")
        try {
            const responseE = await fetch(
                "http://192.188.58.82:3000/reporteYesavajeById/" + dinamicValue + "",
    ...
    const createDynamicTable = () => {
        ...
        */
        ...
        Object.keys(repot).forEach(key => {
            if (key.substring(0, 4) === "ey_p") {
                //arrayx(repot[key])
                array2.push(repot[key])
            }
        })
        ...
        for (let i = 0; i < array2.length - 1; i++) {          
            ...
            if ((i === 0 || i === 4 || i === 6 || i === 10 || i === 12) && array2[i] === 0) {
                arraycolors.push(amarillo)
                arraycolors.push(blanco)
                contador++
            } else if ((i === 0 || i === 4 || i === 6 || i === 10 || i === 12) && array2[i] === 1){
            ...
            if ((i === 1 || i === 2 || i === 3 || i === 5 || i === 7 || i === 8 || i === 9 || 
                i === 11 || i === 13 || i === 14) && array2[i] === 1) {
                arraycolors.push(amarillo)
                arraycolors.push(blanco)
                contador++
            }else if ((i === 1 || i === 2 || i === 3 || i === 5 || i === 7 || i === 8 || i === 9 || 
                i === 11 || i === 13 || i === 14) && array2[i] === 0){                    
                arraycolors.push(blanco)
                arraycolors.push(amarillo)
                contador++
                }
            console.log("valor de i: " + contador)
        }
        ...
        <td style="width: 41.4375px; height: 5.1875px;">${arraycolors[0]}si</td>
        <td style="width: 41.4375px; height: 5.1875px;">${arraycolors[1]}<strong>NO</strong></td>
        </tr>
        ...
        <td style="width: 41.4375px; height: 18px;">${arraycolors[2]}<strong>SI</strong></td>
        <td style="width: 41.4375px; height: 18px;">${arraycolors[3]}no</td>
        </tr>
        <tr style="height: 18px;">
        ...
        <td style="width: 41.4375px; height: 18px;">${arraycolors[4]}<strong>SI</strong></td>
        <td style="width: 41.4375px; height: 18px;">${arraycolors[5]}no</td>
        </tr>
        <tr style="height: 18px;">
        ...
        <td style="width: 41.4375px; height: 18px;">${arraycolors[6]}<strong>SI</strong></td>
        <td style="width: 41.4375px; height: 18px;">${arraycolors[7]}no</td>
        </tr>
        <tr style="height: 18px;">
        ...
        <td style="width: 41.4375px; height: 18px;">${arraycolors[8]}si</td>
        <td style="width: 41.4375px; height: 18px;">${arraycolors[9]}<strong>NO</strong></td>
        </tr>
        ...
        <p>${arraycolors[10]}<strong>SI</strong></p>
        </td>
        <td style="width: 41.4375px; height: 37px;">
        <p>${arraycolors[11]}no</p>
        </td>
        </tr>
        <tr style="height: 18px;">
        ...
        <td style="width: 41.4375px; height: 18px;"><span style="font-weight: 400;">${arraycolors[12]}si</span></td>
        <td style="width: 41.4375px; height: 18px;">${arraycolors[13]}<strong>NO</strong></td>
        </tr>
        <tr style="height: 18px;">
        ...
        <td style="width: 41.4375px; height: 18px;">${arraycolors[14]}<strong>SI</strong></td>
        <td style="width: 41.4375px; height: 18px;">${arraycolors[15]}no</td>
        </tr>
        <tr style="height: 18px;">
        ...
        <td style="width: 41.4375px; height: 18px;">${arraycolors[16]}<strong>SI</strong></td>
        <td style="width: 41.4375px; height: 18px;">${arraycolors[17]}no</td>
        </tr>
        <tr style="height: 18px;">
        <td style="width: 28px; height: 18px; text-align: center;">10</td>
        <td style="width: 772.563px; height: 18px;">&iquest;Siente Ud. que tiene m&aacute;s problemas con su memoria que otras personas de su edad?</td>
        <td style="width: 41.4375px; height: 18px;">${arraycolors[18]}<strong>SI</strong></td>
        <td style="width: 41.4375px; height: 18px;">${arraycolors[19]}no</td>
        </tr>
        <tr style="height: 18px;">
        ...
        <td style="width: 41.4375px; height: 18px;">${arraycolors[20]}si</td>
        <td style="width: 41.4375px; height: 18px;">${arraycolors[21]}<strong>NO</strong></td>
        </tr>
        ...
        <td style="width: 41.4375px; height: 20px;">${arraycolors[22]}<strong>SI</strong></td>
        <td style="width: 41.4375px; height: 20px;">${arraycolors[23]}no</td>
        </tr>
        <tr style="height: 18px;">
        ...
        <td style="width: 41.4375px; height: 18px;">${arraycolors[24]}si</td>
        <td style="width: 41.4375px; height: 18px;">${arraycolors[25]}<strong>NO</strong></td>
        </tr>
        <tr style="height: 18px;">
        ...
        <td style="width: 41.4375px; height: 18px;">${arraycolors[26]}<strong>SI</strong></td>
        <td style="width: 41.4375px; height: 18px;">${arraycolors[27]}no</td>
        </tr>
        <tr style="height: 18px;">
        ...
        <td style="width: 41.4375px; height: 18px;"><span style="font-weight: 400;">${arraycolors[28]}<strong>SI</strong></span></td>
        <td style="width: 41.4375px; height: 18px;">${arraycolors[29]}no</td>
        </tr>
        </tbody>
        </table>
        ...
        <div id="gtx-trans" style="position: absolute; left: 615px; top: 237.031px;">&nbsp;</div>
